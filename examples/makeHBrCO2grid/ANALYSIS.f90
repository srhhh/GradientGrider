...
logical,parameter :: trueSA_flag = .true.
logical,parameter :: trueED_flag = .true.
...
logical,parameter :: testtraj_flag = .false.
   ...
   integer,parameter :: initialbondfolder_length = 7
   character(initialbondfolder_length),parameter :: initialbondfolder = "exp051/"
   ...
   logical :: force_Permutations = .true.
   ...
   logical,parameter :: percentthreshold_flag = .false.
   ...
   integer,parameter :: percentthreshold_key = 0
      ...
      real(dp) :: outer_threshold_SI = .100000d0
      real(dp) :: inner_threshold_SI = 0.00000d0
      real(dp),parameter :: R1_threshold_SI = 3.0000d-6
      real(dp),parameter :: R2_threshold_SI = 1.0000d-3
      integer :: Nsort = 1
      ...
      !$OMP THREADPRIVATE(reject_flag,accept_first,accept_worst)
         ...
         character(14),parameter :: interpolationfolder = "interpolation/"
            ...
            integer,parameter :: Naccept_max = 05
...
!                   (/ 10.0d0, 10.0d-1, 10.0d0 /)
   ...
   logical,parameter :: testtrajSA_flag = .false.

   !Set .true. to generate the scattering angle plots of
   !the trajectories for each grid
   logical,parameter :: testheatmapSA_flag = .false.
...
character(16),parameter :: analysisfile = "ANALYSIS_new.f90"

...
implicit none
real, dimension(3),intent(in) :: coordsH,coords_bond
...
real, intent(in) :: H_bond_distance
real, dimension(3*Natoms), intent(in) :: coords
real, dimension(3),intent(in) :: coords_bond
real, intent(out) :: var2

call getDistanceSquared(coords_bond,coords(7:9),var2)
var2 = dot_product(coords(7:9)-coords_bond, coords_bond) / &
...
call getDistanceSquared(coords(1:3),coords(4:6),var3)
var3 = sqrt(var3)
...
call getDistanceSquared(coords(1:3),coords(7:9),var4)
var4 = sqrt(var4)
